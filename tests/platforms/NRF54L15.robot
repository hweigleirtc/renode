...
Should Run ZephyrRTOS Shell On UART
    Run ZephyrRTOS Shell      ${NO_DMA}  zephyr_shell_nrf54l15.elf-s_1110556-9653ab7fffe1427c50fa6b837e55edab38925681

Should Run ZephyrRTOS Shell On UARTE
    [Tags]   skipped
    Run ZephyrRTOS Shell      ${DMA}     renode-nrf54l15-zephyr_shell_module.elf-gf8d05cf-s_1310072-c00fbffd6b65c6238877c4fe52e8228c2a38bf1f


Should Run Alarm Sample
    Create Machine            ${NO_DMA}  zephyr_alarm_nRF54l15.elf-s_489392-49a2ec3fda2f0337fe72521f08e51ecb0fd8d616
...
Should Echo I2S Audio
    Create Machine            ${STANDARD}   nrf54l15--nordic_snippets_i2s_master.elf-s_181224-98d5e53081cf7d76d30a183978a03b3e00beaf53
...
Should Detect Yes Pattern
    [Tags]                    non_critical
    Create Machine            ${STANDARD}    nrf54l15--tflite-micro_speech.elf-s_7172308-9ab5781883d7af2582d7fea09b14352628da9839
...
Should Run Zephyr's kernel.interrupt Test
    [Tags]                    zephyr
    Create Machine            ${STANDARD}    nrf54l15-zephyr-c320bb0-kernel-interrupt-test.elf-s_737512-7802727d11c415c1859c00842063ebec6c0a6fdc
    Create Terminal Tester    ${UART}
...
Should Run Zephyr's cmsis_dps.transform.rq15 Test
    ...
    [Tags]                    zephyr
    Create Machine            ${STANDARD}    nrf54l15--zephyr-cmsis_transform_rq15.elf-s_1115276-3e1fb95c3d1283d1fe22acf4b8ef887d05455fdf
    Create Terminal Tester    ${UART}
...
Should Restart After Watchdog Timeout
    [Tags]                    zephyr
    Create Machine            ${STANDARD}    nrf54l15--zephyr-watchdog.elf-s_889852-75a696a301c8439400645e646a322039963d74c8
    Create Terminal Tester    ${UART}
...
Should Run Task Watchdog Subsystem
    [Tags]                    zephyr
    Create Machine            ${STANDARD}    nrf54l15--zephyr-task_wdt.elf-s_904904-91eadd958664ba0a009403a1a64f429dce3603a3
    Create Terminal Tester    ${UART}
...
Should Run Bluetooth sample
    ...
    Execute Command           machine LoadPlatformDescription @platforms/cpus/nrf54l15.repl
    Execute Command           sysbus LoadELF ${URI}/nrf54l15--zephyr-bluetooth_central_hr.elf-s_3380332-316e27f81dcda3c2b0e7f2c3516001e7b27ad051
    ...
    Execute Command           machine LoadPlatformDescription @platforms/cpus/nrf54l15.repl
    Execute Command           sysbus LoadELF ${URI}/nrf54l15--zephyr-bluetooth_peripheral_hr.elf-s_3217940-7b59adc9629f8be90067b131e663a13d2d4bb711
    Execute Command           connector Connect sysbus.radio wireless
...
Should Run Bluetooth Hci Uart Sample
    Execute Command           include @scripts/multi-node/nrf54l15-ble-hci-uart-zephyr.resc
